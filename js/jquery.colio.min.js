(function($,undefined){"use strict";function Colio(list,settings){this.list=$(list);this.items=this.list.children();this.settings=settings;this.position=0;this.active_id=undefined;this.lock=false;var self=this;this.items.addClass('colio-item');this.markup=$('<div class="colio"></div>');this.markup.append('<div class="colio-container"></div>');if(this.settings.navigation){this.markup.addClass('colio-has-navigation');$('<div class="colio-navigation"></div>').appendTo(this.markup);}
